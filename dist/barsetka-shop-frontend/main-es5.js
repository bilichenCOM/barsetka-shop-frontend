  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function JYN(module, __webpack_exports__, __webpack_require__) {
      ...
      function AdministrationComponent_div_7_Template(rf, ctx) {
        ...
        if (rf & 2) {
          var adminItem_r61 = ctx.$implicit;
    ...
    function ck6K(module, __webpack_exports__, __webpack_require__) {
      ...
      function ProductsAdministrationComponent_div_9_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ProductsAdministrationComponent_div_11_img_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "img", 24);
        }

        if (rf & 2) {
          var pr_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
      ...
      function ProductsAdministrationComponent_div_11_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductsAdministrationComponent_div_11_Template_button_click_16_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);

            var pr_r17 = ctx.$implicit;

            var ctx_r20 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r20["delete"](pr_r17);
          });
      ...
      function ProductsAdministrationComponent_div_12_Template(rf, ctx) {
        if (rf & 1) {
          ...
          value: function ngOnInit() {
            ...
            this.categoryService.getAll().subscribe(function (cats) {
              cats.forEach(function (cat) {
                _this7.categoryService.getAllProducts(cat.id).subscribe(function (prs) {
                  return _this7.products = prs;
                });
              });
            });
          }
          ...
          value: function ngOnInit() {
            ...
            if (path === 'new') {
              ...
              this.productService.getById(+path).subscribe(function (pr) {
                return _this11.prod = pr;
              });
            }

            this.categoryService.getAll().subscribe(function (cats) {
              return _this11.categories = cats;
            });
          }
        }, {
          key: "submit",
      ...
      ProductDetailsAdministrationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function ProductDetailsAdministrationComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function ProductDetailsAdministrationComponent_Template_input_ngModelChange_16_listener($event) {
          ...
          value: function success() {
            ...
            if (window.navigator.geolocation) {
              window.navigator.geolocation.getCurrentPosition(function (loc) {
                ...
                _this14.logService.save(log).subscribe(function (res) {
                ...
                console.log(err);
                _this14.errHelpMsg = true;
                _this14.err = err.code + '';
        ...
        _createClass(DeliveryFormComponent, [{
          ...
          value: function onSubmit() {
            ...
            this.deliveryService.addNewItem(delivery).subscribe(function (data) {
              _this17.deliveryItem = data;
              _this17.cart.items = [];
              _this17.cart.totalPrice = 0.0;

              _this17.cartService.update(_this17.cart);

              _this17.submited = true;
            }, function (err) {
              return console.log(err);
            });
          }
      ...
      var LoginComponent = /*#__PURE__*/function () {
        ...
        _createClass(LoginComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.authenticationService.getCurrentAuthentication().subscribe(function (data) {
              if (data) {
                _this19.router.navigateByUrl('/main', {
                  queryParams: {
                    login: true
                  }
                });
          ...
          value: function onSubmit() {
            ...
            this.authenticationService.login(auth).subscribe(function (data) {
              _this20.userService.saveCurrentUser(data);

              _this20.successLoggedIn = true;
              console.log('successfully logged in');

              _this20.authenticationService.save(auth);

              location.reload();
            }, function (err) {
              _this20.successLoggedIn = false;
      ...
      function ProductDetailsComponent_li_10_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductDetailsComponent_li_10_Template_li_click_0_listener() {
            ...
            var photoUrl_r42 = ctx.$implicit;

            var ctx_r43 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r43.selectPhotoUrl(photoUrl_r42);
          });
        ...
        _createClass(ProductDetailsComponent, [{
          ...
          value: function getProduct() {
            ...
            this.productService.getById(productId).subscribe(function (product) {
              ...
              _this21.selectedPhotoUrl = product.photoUrls[0];
            }, function (error) {
              return console.log(error);
            });
          }
    ...
    function ziXE(module, __webpack_exports__, __webpack_require__) {
      ...
      function ProductsComponent_div_5_img_2_Template(rf, ctx) {
        ...
        if (rf & 2) {
          var pr_r36 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
